...
// nestedFunction can access the variable internal because it is in the scope of myFunction by being placed in myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    ...
    zooAnimals.forEach(zooAnimal => {
      let name = zooAnimal.animal_name
      let sName = zooAnimal.scientific_name
      let dName = `name: ${name}, scientific: ${sName}`
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    return zooAnimals.filter(name => name.population < 5);
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    return zooAnimals.reduce((accumulator, name) => {
      return accumulator + name.population;
    }, 0);
...
let cuboidTwo = new CuboidMakerTwo(4, 7, 3);
